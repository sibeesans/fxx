...
# Author  : Yth Bagoes
# (C) Copyright 2021-2022 By Bagoes
# =========================================
...
echo -e "         OWNER : ${GREEN}Bagoes Vpn ${NC}${YELLOW}(${NC} ${GREEN}BAGOES ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By BAGOES ${YELLOW}(${NC} 2021-2022 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
